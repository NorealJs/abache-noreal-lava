...
<div class="card">
    <div class="topline">
        ...
        <a class="back" href="<?= base_url('products'); ?>">← Back to list</a>
    </div>
    ...
    <form method="post" action="<?= $form_action; ?>">
        ...
        <textarea id="description" name="description" placeholder="Enter product description"><?= htmlspecialchars($product['description'] ?? ''); ?></textarea>
